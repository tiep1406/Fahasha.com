...
<div class="container">
	<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 logo" style="margin-top: 10px;">
		<a href="<?php echo base_url() ?>"><img src="<?php echo base_url() ?>public/images/fahasa-logo.png" alt="Green Construction"></a>
	</div>
	<div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 search">
		<form action="search" method="get" role="form">
			<div class="input-search" style="border-color: #FF8000;">
