        ...
        <div class="container">
            <div class="col-xs-12 cp;-sm-12 col-md-4 col-lg-4 item">
                <div class="img-service">
                    <img src="public/images/ico_flashsale@3x.png" class="pull-left">
                </div>
                <div class="text-img">
                    <h4 class="pull-left clear-fix">Flash Sale</h4>
                </div>
            </div>
            <div class="col-xs-12 cp;-sm-12 col-md-4 col-lg-4 item">
                <div class="img-service">
                    <img src="public/images/ico_dealhot@3x.png" class="pull-left">
                </div>
                <div class="text-img">
                    <h4 class="pull-left">Deal Hot</h4>
                </div>
            </div>
            <div class="col-xs-12 cp;-sm-12 col-md-4 col-lg-4 item">
                <div class="img-service">
                    <img src="public/images/ico_Fpointstore@3x.png" class="pull-left">
                </div>
                <div class="text-img">
                    <h4 class="pull-left">F-Point Store</h4>
                </div>
    ...
    <div class="container">
        <div class="banner">
            <div class="item-banner">
                <a href="">
                    <img src="public/images/BannerBalo_310x210.jpg">
                </a>
            </div> 
            <div class="item-banner">
                <a href="">
                    <img src="public/images/ZalopayT8_310x210.jpg">
                </a>
            </div>
            <div class="item-banner">
                <a href="">
                    <img src="public/images/VN-Pay-19-08-310x210.png">
                </a>
            </div>
        </div>
    </div>
                        ...
                        <?php foreach ($listProducts as $rowProducts) :?>
                            <div class="col-xs-6 col-sm-4 col-md-2 col-lg-2 product-one">
                                ...
                                <div class="btn-action">
                                    ...
                                    <button type="button" >
                                        <a href="<?php echo $rowProducts['alias'] ?>" title="" class="ws-nw overflow ellipsis">
                                            <i class="fa fa-eye" style="color: #685e52;" ></i>
                                            <?php  $rowProducts['name']?> 
                                        </a>
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="item">
                            <div class="col-xs-12">
                                <div class="item-brand">
                                    <img width="158" height="103" src="public/images/images.jpg" class="img-fix" alt="sati">
                                </div> 
                            </div>
                        </div>
                        <div class="item">
                          <div class="col-xs-12">
                                <div class="item-brand">
                                    <img width="158" height="103" src="public/images/images.png" class="img-fix" alt="sati">
                                </div> 
                            </div>
                        </div>
                        <div class="item">
                          <div class="col-xs-12">
                                <div class="item-brand">
                                    <img width="158" height="103" src="public/images/unnamed.jpg" class="img-fix" alt="sati">
                                </div> 
                            </div>
                        </div>
                        <div class="item">
                          <div class="col-xs-12">
                                <div class="item-brand">
                                    <img width="158" height="103" src="public/images/f4866702-04b5-11e7-8347-56c566ee3692_ODDU.jpg" class="img-fix" alt="sati">
                                </div> 
                            </div>
                        </div>
                        <div class="item">
                          <div class="col-xs-12">
                                <div class="item-brand">
                                    <img width="158" height="103" src="public/images/112.png" class="img-fix" alt="sati">
                                </div> 
                            </div>
                        </div>
                        <div class="item">
                          <div class="col-xs-12">
                                <div class="item-brand">
                                    <img width="158" height="103" src="public/images/NXBTrelogo.jpeg" class="img-fix" alt="sati">
                                </div> 
                            </div>
                        </div>
                        <div class="item">
                          <div class="col-xs-12">
                                <div class="item-brand">
                                    <img width="158" height="103" src="public/images/nxbkimdong-logo.jpg" class="img-fix" alt="sati">
                                </div> 
                            </div>
                        </div>
                    </div>
